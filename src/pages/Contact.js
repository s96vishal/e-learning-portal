                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>E- Learning Portal India</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:12345678">(020) 12345678</a><a href="tel:1234567890">(020) 123456789</a></span>
                                </li>
                                <li>
