...
export default class CreateEnroll extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://e-learning-portal-2022.herokuapp.com/courses/")
      .then(response => {
    ...
    axios
      .get("https://e-learning-portal-2022.herokuapp.com/users/")
      .then(response => {
  ...
  onSubmit(e) {
    ...
    axios.post("https://e-learning-portal-2022.herokuapp.com/enroll/add/", newTodo).then(result => {
