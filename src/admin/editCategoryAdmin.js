...
export default class CatEdit extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://e-learning-portal-2022.herokuapp.com/category?id=" + this.props.match.params.id)
      .then(response => {
  ...
  onSubmit = e => {
    ...
    axios
      .put("https://e-learning-portal-2022.herokuapp.com/category?id=" + this.props.match.params.id, {
        no,
        categoryName
      })
      .then(result => {
