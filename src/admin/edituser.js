...
export default class UserEdit extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://e-learning-portal-2022.herokuapp.com/user?id='+this.props.match.params.id)
            .then(response => {
            ...
            axios.get('https://e-learning-portal-2022.herokuapp.com/showroles/')
            .then(response => {
    ...
    delete(id){
      console.log(id);
      axios.delete('https://e-learning-portal-2022.herokuapp.com/user?id='+this.props.match.params.id)
        .then((result) => {
    ...
    onSubmit = (e) => {
        ...
        axios.put('https://e-learning-portal-2022.herokuapp.com/user?id='+this.props.match.params.id, {first_name, last_name, email, password, role})
        .then((result) => {
          this.props.history.push("/allusers/")
        });
    }
