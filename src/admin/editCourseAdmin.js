...
export default class EditCourse extends Component{
    ...
    componentDidMount() {
        ...
        axios.get('https://e-learning-portal-2022.herokuapp.com/course?id='+this.props.match.params.id)
            .then(response => {
        ...
        axios.get('https://e-learning-portal-2022.herokuapp.com/categories/')
        .then(response => {
        ...
        onSubmit = (e) => {
            ...
            axios.put('https://e-learning-portal-2022.herokuapp.com/course?id='+this.state.todos._id, {courseName, courseDescription, category, instructor})
            .then((result) => {
