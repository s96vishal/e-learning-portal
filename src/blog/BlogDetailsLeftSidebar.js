...
class BlogDetailsLeftSidebar extends Component {
  ...
  onClick(e) {
    ...
    if (this.state.buttonclass == "btn btn-success") {
      axios
        .post("https://e-learning-portal-2022.herokuapp.com/enrollbystudent/add", newTodo)
        .then(result => {
  ...
  async componentDidMount() {
    ...
    const response = await axios
      .get("https://e-learning-portal-2022.herokuapp.com/lectures?id=" + this.props.match.params.id)
      .then(result => {
        console.log(
          "https://e-learning-portal-2022.herokuapp.com/checkenrollment?id=" +
            this.state.user +
            "&&courseid=" +
